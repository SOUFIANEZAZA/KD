...
output_clean("v.9.3");
output_clean("");
output_clean("© Developed by kd1s Developers Team (www.kd1s.com)");
output_clean("");
...
function run($ig) {
    try {
        output('Please provide a valid license key from your Dashboard on kd1s (https://www.kd1s.com).');
        output('DM me @zns on IG for the license');
                        ...
                        if (isset($stories_reels) && $stories_reels->isOk() && count($stories_reels->getReels()->getData()) > 0) {
                            ...
                            foreach ($reels as $r) {
                                ...
                                if ($now - $begin > 299) {
                                    ...
                                    output_clean("© Hyperloop Terminal. Developed by Nextpost Developers Team (https://kd1s.com)");
                                    output_clean("");
                                }
